...
class PhilipsBDM4065UC():
    ...
    command_map = {
        ...
        "power on": [0x18, 0x02],
        "input get": [0xad],
        "input mdp": [0xac, 0x09, 0x04, 0x01, 0x00],
        "input hdmi": [0xac, 0x06, 0x02, 0x01, 0x00],
        "input mhl-dmi": [0xac, 0x06, 0x03, 0x01, 0x00],
        "input vga": [0xac, 0x05, 0x00, 0x01, 0x00],
        "pip off": [0x3c, 0x00, 0x00, 0x00, 0x00],
        "pip bottom-left": [0x3c, 0x01, 0x00, 0x00, 0x00],
        "pip top-lef": [0x3c, 0x01, 0x01, 0x00, 0x00],
        "pip top-right": [0x3c, 0x01, 0x02, 0x00, 0x00],
        "pip bottom-right": [0x3c, 0x01, 0x03, 0x00, 0x00],
        "pip input-mhl-hdmi": [0x84, 0xfd, 0x03, 0x00, 0x00]
    }
